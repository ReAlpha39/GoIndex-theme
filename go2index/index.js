// =======Options START=======
var authConfig = {
  siteName: "GoIndex-theme-acrou", // Website name
...
var themeOptions = {
  cdn: "https://cdn.jsdelivr.net/gh/ReAlpha39/goindex-theme-acrou",
...
async function handleRequest(request) {
  if (gds.length === 0) {
    ...
    // This task is parallel and improves efficiency
    let tasks = [];
    gds.forEach((gd) => {
 ...
 * @param gd
 * @returns {Promise<Response>} Note: If the item represented by the id received from the foreground is not under the target gd disk, then the response will be returned to the foreground with an empty string ""
 */
